	...
	<input type="hidden" class="input-text" value="${eduClass.ecid}" placeholder="" id=ecid name="ecid">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${resClass.rcclass}" id="rcclass" name="rcclass">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	/* 檢驗重名 */
	$("#rcclass").change('input propertychange',function(){
		$.ajax({
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){	//表单提交句柄,为一回调函数，带一个参数：form 
			$(form).ajaxSubmit({
				 type: 'post',
			    url: "${pageContext.request.contextPath}/resClass/resClassUpd.action",
			    success: function(data){
