...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		...
		</a> <a class="btn btn-primary radius" onclick="add('添加分类','${pageContext.request.contextPath}/resClass/resClassPreAdd.action')" href="javascript:;">
		...
		<table  class="table table-border table-bordered table-bg table-hover table-sort" >
			...
			<c:forEach var="rcList" items="${rcList}">
				<tr id="tr" class="text-c" style="font-size: 70px">
					<td><input type="checkbox" value="${rcList.rcid }" name="tag"></td>
					<td class="text-c" name="rcid">${rcList.rcid }</td>
					<td class="text-c">${rcList.rcclass }</td>
					<td class="td-manage">
						<!-- <a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架">
							<i class="Hui-iconfont">&#xe6de;</i>
						</a> --> 
						<a style="text-decoration:none" class="ml-5" onClick="edit('编辑','${pageContext.request.contextPath}/resClass/resClassPreUpd.action?rcid=${rcList.rcid }')" href="javascript:;" title="编辑">
							<i class="Hui-iconfont">&#xe6df;</i>
						</a> 
						<!-- onClick="edu_del(this,${eList.eid })" -->
						<a style="text-decoration:none" class="ml-5"  href="${pageContext.request.contextPath}/resClass/resClassDel.action?rcid=${rcList.rcid }" title="删除">
							<i class="Hui-iconfont">&#xe6e2;</i>
						</a>
					</td>
				</tr>
...
                    "${pageContext.request.contextPath}/resClass/resClassAllDel.action?ids="+res.toArray().join(","),
                    function(data){
                       /*  if(data == "ok"){
