...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="${pageContext.request.contextPath}/teaClass/teaClassAdd.action" method="post" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>名稱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tcclass" name="tcclass">
			</div>
		</div>
		<div class="row cl">
		</div>
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){	//表单提交句柄,为一回调函数，带一个参数：form 
			...
			$(form).ajaxSubmit({
				 type: 'post',
			    url: "${pageContext.request.contextPath}/teaClass/teaClassAdd.action",
			    success: function(data){
