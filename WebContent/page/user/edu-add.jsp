...
<title>新增文章 - 教育管理</title>
<jsp:include page="elements/link.jsp"></jsp:include>
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="${pageContext.request.contextPath}/edu/eduAdd.action" method="post" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="ename" name="ename">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<!-- <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'commentdatemax\')||\'%y-%M-%d\'}' })" id="commentdatemin" name="commentdatemin" class="input-text Wdate">
				 --><input type="text" onfocus="WdatePicker({ Date:'%y-%M-%d' })" id="edate" name="edate" class="input-text Wdate" style="width:120px;">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				...
				-->
				<textarea name="emessage" style="height:auto; font-size:14px; width: 545px;height: 250px"></textarea>
			 </div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){	//表单提交句柄,为一回调函数，带一个参数：form 
			/* $(form).ajaxSubmit(${pageContext.request.contextPath}/edu/eduAdd.action,function(msg){
			...
			$(form).ajaxSubmit({
				 type: 'post',
			    url: "${pageContext.request.contextPath}/edu/eduAdd.action",
