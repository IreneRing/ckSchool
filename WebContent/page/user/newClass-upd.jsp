...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="${pageContext.request.contextPath}/newClass/newsClassUpd.action" method="post" >
	<input type="hidden" class="input-text" value="${newsClass.ncid}" placeholder="" id=ncid name="ncid">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${newsClass.ncclass}" id="ncclass" name="ncclass">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	/* 檢驗重名 */
	$("#ncclass").change('input propertychange',function(){
		$.ajax({
			url:  "${pageContext.request.contextPath}/newClass/newsClassCheck.action?ncclass="+$("#ncclass").val(),
	        type: "post",
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){	//表单提交句柄,为一回调函数，带一个参数：form 
			$(form).ajaxSubmit({
				 type: 'post',
			    url: "${pageContext.request.contextPath}/newClass/newsClassUpd.action",
			    success: function(data){
