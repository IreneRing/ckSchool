...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 新聞分类 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		...
		</a> <a class="btn btn-primary radius" onclick="add('添加分类','${pageContext.request.contextPath}/newClass/newsClassPreAdd.action')" href="javascript:;">
		...
		<table  class="table table-border table-bordered table-bg table-hover table-sort" >
			...
			<c:forEach var="ncList" items="${ncList}">
				<tr id="tr" class="text-c" style="font-size: 70px">
					<td><input type="checkbox" value="${ncList.ncid }" name="tag"></td>
					<td class="text-c" name="ncid">${ncList.ncid }</td>
					<td class="text-c">${ncList.ncclass }</td>
					<td class="td-manage">
						<!-- <a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架">
							<i class="Hui-iconfont">&#xe6de;</i>
						</a> --> 
						<a style="text-decoration:none" class="ml-5" onClick="edit('编辑','${pageContext.request.contextPath}/newClass/newsClassPreUpd.action?ncid=${ncList.ncid }')" href="javascript:;" title="编辑">
							<i class="Hui-iconfont">&#xe6df;</i>
						</a> 
						<!-- onClick="edu_del(this,${eList.eid })" -->
						<a style="text-decoration:none" class="ml-5"  href="${pageContext.request.contextPath}/newClass/newsClassDel.action?ncid=${ncList.ncid }" title="删除">
							<i class="Hui-iconfont">&#xe6e2;</i>
						</a>
					</td>
				</tr>
...
                    "${pageContext.request.contextPath}/newClass/newsClassAllDel.action?ids="+res.toArray().join(","),
                    function(data){
                       /*  if(data == "ok"){
...
$("#select").change(function(){
	var url="${pageContext.request.contextPath}/eduClass/findEducationAndClassByClass.action?ecid="+$("#select").val();
